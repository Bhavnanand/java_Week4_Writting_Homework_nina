 ...
 */
public class Programme_DigitSumChallenge {
    public static int sumDigits(int number){
        if (number>=10){
            int digit,sum =0;
            while (number>0) {
                //find the last digit of the givne number
                digit = number % 10;
                //adds las tdigit of the given number
                sum = sum + digit;
            ...
            //return =1 fro negative number and one number
            return -1;
        }
    }
